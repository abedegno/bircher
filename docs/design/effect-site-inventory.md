...
| 3873 | `gh issue edit --remove-label` | `issue_or_label` |
| 3874 | `gh issue edit --add-label` | `issue_or_label` |
| 3890 | `gh issue close` | `issue_or_label` |
| 4471 | `gh issue edit --add-label bircher:running` | `issue_or_label` |
